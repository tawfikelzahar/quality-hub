        ...
        <section id="tools" className="qh-landing-section" style={{position:'relative',zIndex:1,maxWidth:1100,margin:'0 auto',padding:'100px 32px'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(320px,1fr))',gap:20}}>
            ...
            <Link href="/oee" className="card" style={{background:cardBg,border:`1px solid ${cardBorder}`,borderRadius:20,padding:32,textDecoration:'none',color:'inherit',display:'flex',flexDirection:'column',gap:20}}>
              ...
              <div>
                <div style={{fontSize:20,fontWeight:700,marginBottom:8}}>OEE Calculator</div>
                <div style={{fontSize:13,color:c.muted,lineHeight:1.75,fontWeight:300}}>Availability × Performance × Quality · Six Big Losses · World-class benchmark</div>
              </div>
              <div style={{display:'flex',flexWrap:'wrap',gap:6}}>
                {['JIPM TPM','Six Big Losses','CSV/Excel/PDF Export'].map(t=>(
                  <span key={t} style={{fontSize:11,color:'#0fd4c8',background:'rgba(15,212,200,.06)',border:'1px solid rgba(15,212,200,.12)',borderRadius:20,padding:'3px 10px'}}>{t}</span>
                ))}
              </div>
              <div style={{fontSize:13,fontWeight:600,color:'#0fd4c8'}}>Open Tool →</div>
